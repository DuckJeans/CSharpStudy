...
//1. // 해당 줄은 주석 처리 된다. (컴퓨터는 알아볼 수 없게 된다.)
//2. /* */ : /* ~ */ 모두 주석 처리 하라
...
namespace CSharpStudy
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("두 수를 더해주는 프로그램 입니다.");
            ...
            Console.WriteLine("문자열의 덧셈결과 : " + input + inputA);
            Console.WriteLine("정수의 덧셈결과 : " + (inputNumber + inputNumber2));
            ...
            string width;
            width = Console.ReadLine(); //가로의 길이를 문자로 입력받아서, 정수형으로 변환을 해주세요
            int widthNumber = int.Parse(width);

            Console.Write("세로의 크기를 입력해주세요 : ");
            string height;
            height = Console.ReadLine(); //세로의 길이를 문자로 입력받아서, 정수형으로 변환을 해주세요
            int heightNumber = int.Parse(height);

            Console.WriteLine($"사각형의 넓이 : {widthNumber * heightNumber}");
            
            //원의 넓이를 구하는 프로그램도 만들어 보세요
            //반지름 * 반지름 * 3.14
